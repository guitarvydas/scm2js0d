...
components_to_include_in_project :: proc (leaves: ^[dynamic]zd.Leaf_Template) {
    zd.append_leaf (leaves, std.string_constant ("scm2js"))
    zd.append_leaf (leaves, std.string_constant ("scm2js.ohm"))
    zd.append_leaf (leaves, std.string_constant ("scm2js.rwr"))
